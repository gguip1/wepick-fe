...
import { PostsAPI } from '/shared/api/posts.js';
...
import { setupRealtimeValidation, validateForm } from '/shared/utils/validation.js';
import { createDraggableList } from '/shared/utils/drag-drop.js';
import { validateImageFile, uploadImage, createImagePreview, revokeImagePreview } from '/shared/utils/image-upload.js';
import { createCharCounter, createFormController } from '/shared/utils/form-helpers.js';
import { loadHeader as loadHeaderComponent, loadFooter as loadFooterComponent } from '/shared/utils/component-loader.js';
